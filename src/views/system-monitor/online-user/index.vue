<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="登录日期" width="160px" align="center">
        <template slot-scope="{ row }">
      ...
      >
        <template slot-scope="{row}">
          <!-- 操作1：简单的按钮模式 -->
          <el-button type="primary" size="mini" @click="handleKick(row)">
            强退
          </el-button>
...
<script>
import { fetchList, kickOut } from '@/api/system-monitor/online-user'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.listQuery.page = this.listQuery.current - 1
