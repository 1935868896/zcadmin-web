<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.author" placeholder="Author" style="width: 200px;margin-left: 10px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="updateAt" width="150px" align="center">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="updateAt" prop="timestamp">
          <el-date-picker v-model="temp.updateAt" value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="Please pick a date" />
        </el-form-item>
...
<script>
import { fetchList, fetchPv, create, update } from '@/api/project-mange/book-info'
